...
Using the command terminal, navigate to the directory 'MainBuild/target'. Enter
the command:
...
Javadocs can be generated using mvn javadoc:javadoc, which will then generate the site in 'Mainbuild/target/site/apidocs'
